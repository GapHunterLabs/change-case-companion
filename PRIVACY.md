# Privacy Policy — Change Case Companion

**Effective date:** 2026-08-14

Change Case Companion is a Gap Hunter Labs plugin for IntelliJ
...
**Nothing.** Change Case Companion does not collect, store, transmit,
...
**None.** Change Case Companion makes zero network calls during normal
operation. Every conversion it performs runs entirely in-process,
inside your IDE, against the text already open in your editor. Nothing
you write, open, or edit is ever sent anywhere.

## Third parties

None. Change Case Companion has no third-party SDKs, no analytics
