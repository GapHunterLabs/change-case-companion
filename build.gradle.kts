...
dependencies {
    ...
    intellijPlatform {
        ...
        // No bundledPlugin(...) needed -- this plugin only touches
        // Editor/Document text, never PSI, so it works identically in
        // any file type (Java, Kotlin, JSON, YAML, plain text...)
        // without depending on any language plugin.
